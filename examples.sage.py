...
representation= Phi(_sage_const_3 ,_sage_const_0 ,_sage_const_0 ) # SL_2 is acting on a 3 dimensional weight system with highest weight 3omega_1
...
representation= Phi2(_sage_const_3 ,_sage_const_0 ,_sage_const_0 ,_sage_const_0 ,_sage_const_0 ,_sage_const_0 ,_sage_const_0 ) # G_2 is acting on a 7 dimensional weight system with highest weight 3omega_1
P2=GITProblem(representation,label="Weird cubics")
print(P2.OPS_rays_list)
input('hey')
